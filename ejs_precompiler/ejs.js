...
vEJS.Compiler.prototype = {
  compile: function(options, name) {
	...
	var to_be_evaled = name+'= function(_CONTEXT,_VIEW) { try { with(_VIEW) { with (_CONTEXT) {'+this.out+" return ___ViewO.join('');}}}catch(e){e.lineNumber=null;throw e;}};";
...
vEJS.config( {cache: true, type: '<', ext: '.html' } );
